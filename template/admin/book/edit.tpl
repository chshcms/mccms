    ...
    <form class="layui-form layui-form-pane" action="<?=links('book','save')?>">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md4">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" required lay-verify="required" class="layui-input" value="<?=$name?>" placeholder="请输入小说标题">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md6">
                <label class="layui-form-label">简介</label>
                <div class="layui-input-block">
                    <input type="text" name="text" class="layui-input" value="<?=$text?>" placeholder="一句话介绍小说，20个字以内">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md3">
                ...
                <div class="layui-input-block">
                    <input type="text" name="author" class="layui-input" value="<?=$author?>" placeholder="请输入小说作者名字">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md3">
                <label class="layui-form-label">英文别名</label>
                <div class="layui-input-block">
                    <input type="text" name="yname" class="layui-input" value="<?=$yname?>" placeholder="请输入小说英文别名">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md6">
                <label class="layui-form-label">Tags标签</label>
                <div class="layui-input-block">
                    <input type="text" name="tags" class="layui-input" placeholder="请填Tags标签,多个用/隔开" value="<?=$tags?>">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" id="pic" name="pic" class="layui-input" placeholder="请上传小说竖版封面或者输入图片URL" value="<?=$pic?>">
            ...
            <div class="layui-col-xs12 layui-col-md6">
                ...
                <div class="layui-input-block">
                    <input type="text" id="picx" name="picx" class="layui-input" placeholder="请上传小说横版封面或者输入图片URL" value="<?=$picx?>">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md2">
                ...
                <div class="layui-input-block">
                    <input type="number" name="rhits" class="layui-input" value="<?=$rhits?>" placeholder="请输入小说日人气">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">周人气</label>
                <div class="layui-input-block">
                    <input type="number" name="zhits" class="layui-input" value="<?=$zhits?>" placeholder="请输入小说周人气">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">月人气</label>
                <div class="layui-input-block">
                    <input type="number" name="yhits" class="layui-input" value="<?=$yhits?>" placeholder="请输入小说月人气">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">总人气</label>
                <div class="layui-input-block">
                    <input type="number" name="hits" class="layui-input" value="<?=$hits?>" placeholder="请输入小说总人气">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">总字数</label>
                <div class="layui-input-block">
                    <input type="text" name="text_num" class="layui-input" placeholder="总字数,一般会自动获取" value="<?=$text_num?>">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">总得分</label>
                <div class="layui-input-block">
                    <input type="number" name="score" class="layui-input" value="<?=$score?>" placeholder="小说评分总得分">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="editor2" name="notice" placeholder="作者小说公告" class="layui-textarea"><?=$notice?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">小说简介</label>
            <div class="layui-input-block">
                <textarea id="editor2" name="content" placeholder="小说简介" class="layui-textarea" style="min-height:100px;"><?=$content?></textarea>
            </div>
        </div>
