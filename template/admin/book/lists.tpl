            ...
            <for class="layui-form toolbar">
                <div class="layui-form-item" style="margin-top: 10px;">
                    <div class="layui-inline">
                        ...
                        <button class="layui-btn icon-btn layui-btn-sm layui-btn-normal" onclick="Admin.open('新增分类','<?=links('book','lists_edit')?>',500,390);"><i class="layui-icon">&#xe624;</i>添加分类</button>
                    </div>
                </div>
