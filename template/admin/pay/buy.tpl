            ...
            <div class="layui-tab layui-tab-brief">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form toolbar">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('pay','buy_del',$type)?>','pay')"><i class="layui-icon"></i>批量删除</button>
                        ...
                        <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('pay','buy_ajax',$type)?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'pay'}" lay-filter="pay">
                          <thead>
                            <tr>
