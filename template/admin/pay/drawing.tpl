            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('pay','drawing_del')?>','drawing')"><i class="layui-icon"></i>批量删除</button>
                        <button class="layui-btn icon-btn layui-btn-sm layui-btn-normal" onclick="Admin.get_excel('drawing');"><i class="layui-icon">&#xe67d;</i>导出xls</button>
                    </div>
                    ...
                    <div class="layui-inline mr0">
                        <button class="layui-btn layui-btn-sm" data-id="drawing" lay-submit lay-filter="table-sreach">
                            <i class="layui-icon">&#xe615;</i>搜索
                        </button>
                    </div>
                </div>
            </div>
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('pay','drawing_ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'drawing'}" lay-filter="drawing">
              <thead>
                <tr>
