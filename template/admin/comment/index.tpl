        ...
        <div class="layui-card-body">
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    <li class="layui-this"><a href="<?=links('comment','index')?>">评论列表</a></li>
                    <li><a href="<?=links('comment','index','reply')?>">回复列表</a></li>
                </ul>
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('comment','ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'comment'}" lay-filter="comment">
                          <thead>
                            <tr>
                            ...
                            <?php }else{ ?>
                                <th lay-data="{field:'id',type:'checkbox',width:40,align:'center'}"></th>
                                <th lay-data="{field:'id',sort: true,width:70,align:'center'}">评论ID</th>
                                <th lay-data="{field:'text'}">评论内容</th>
                                <th lay-data="{field:'uid',width:80,align:'center'}">会员ID</th>
                                <th lay-data="{field:'mid',width:80,align:'center'}">漫画ID</th>
                                <th lay-data="{field:'bid',width:80,align:'center'}">小说ID</th>
                                <th lay-data="{field:'ip',width:120,align:'center'}">评论IP</th>
                                <th lay-data="{field:'reply_num',width:80,align:'center'}">回复</th>
...
<script type="text/html" id="cmd2Tpl">
    <button style="margin-left:5px;" title="删除" class="layui-btn-danger layui-btn layui-btn-xs" onclick="Admin.del('<?=links('comment','del')?>','{{d.id}}',this)" href="javascript:;" ><i class="layui-icon">&#xe640;</i></button>
</script>
