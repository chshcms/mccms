...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-form toolbar">
                <div class="layui-form-item" style="margin-top: 10px;">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('user','signing_del')?>','user')"><i class="layui-icon">&#xe640;</i>取消签约</button>
                    </div>
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('user','signing_ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'user'}" lay-filter="user">
              <thead>
                <tr>
...
<script type="text/html" id="cmdTpl">
    ...
    <button style="margin-left:5px;" title="取消签约" class="layui-btn-danger layui-btn layui-btn-xs" onclick="Admin.del('<?=links('user','signing_del')?>','{{d.id}}',this)" href="javascript:;" ><i class="layui-icon">&#xe640;</i></button>
</script>
<script>
function show_img(t) {
    var t = $(t).find("img");
