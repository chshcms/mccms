            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('app','invite_del')?>','pay')"><i class="layui-icon"></i>批量删除</button>
                    </div>
                    ...
                    <div class="layui-inline mr0">
                        <div class="layui-input-inline h30">
                            <select name="zd">
                                <option value="inviteid">邀请用户ID</option>
                                <option value="uid">被邀请用户ID</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-inline mr0">
                        <div class="layui-input-inline">
                            <input type="text" name="key" placeholder="请输入用户ID" autocomplete="off" class="layui-input h30" value="">
                        </div>
                    </div>
                    <div class="layui-inline mr0">
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('app','invite_ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'pay'}" lay-filter="pay">
              <thead>
                ...
                <?php if(defined('MOBILE')){ ?>
                    ...
                    <th lay-data="{field:'inviteid',align:'center'}">邀请人ID</th>
                    <th lay-data="{field:'uid',align:'center'}">被邀请人ID</th>
...
<script type="text/html" id="cmdTpl">
    <button style="margin-left:5px;" title="删除" class="layui-btn-danger layui-btn layui-btn-xs" onclick="Admin.del('<?=links('app','invite_del')?>','{{d.id}}',this)" href="javascript:;" ><i class="layui-icon">&#xe640;</i>删除</button>
</script>
</body>
</html>