        ...
        <div class="layui-card-body">
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    <li<?php if($yid==0) echo ' class="layui-this"';?>><a href="<?=links('comic')?>">已审漫画</a></li>
                    <li<?php if($yid==1) echo ' class="layui-this"';?>><a href="<?=links('comic','index',1)?>">待审漫画</a></li>
                    <li<?php if($yid==2) echo ' class="layui-this"';?>><a href="<?=links('comic','index',2)?>">未通过漫画</a></li>
                    <li<?php if($yid==3) echo ' class="layui-this"';?>><a href="<?=links('comic','index',3)?>">检测重复漫画</a></li>
                </ul>
                        ...
                        <div class="layui-form toolbar">
                            <div class="layui-form-item" style="margin-top: 10px;">
                                <div class="layui-inline">
                                    <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('comic','del')?>','comic')"><i class="layui-icon">&#xe640;</i>删除</button>
                                    <button class="layui-btn icon-btn layui-btn-sm layui-btn-normal" onclick="Admin.open('新增漫画','<?=links('comic','edit')?>',0,0,1);"><i class="layui-icon">&#xe624;</i>新增</button>
                                </div>
                                <?php if($yid < 3){ ?>
                                <div class="layui-inline select100 mr0">
                                    <div class="layui-input-inline h30">
                                        <select name="cid">
                                        <option value="">漫画分类</option>
                                        <?php
                                ...
                                <div class="layui-inline select100 mr0">
                                    <div class="layui-input-inline h30">
                                        <select name="zd">
                                            <option value="name">漫画名称</option>
                                            <option value="author">漫画作者</option>
                                            <option value="id">漫画ID</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="layui-inline mr0">
                        ...
                        <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('comic','ajax',$yid)?>?name=<?=$name?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'comic'}" lay-filter="comic">
                          <thead>
                            ...
                            <?php if(defined('MOBILE')){ ?>
                                ...
                                <th lay-data="{field:'name',templet:'#nameTpl'}">漫画名称</th>
                                <th lay-data="{align:'center',width:120,templet:'#cmdTpl'}">操作</th>
                            <?php }else{ ?>
                                <th lay-data="{field:'id',type:'checkbox',width:40,align:'center'}"></th>
                                <th lay-data="{field:'id',sort: true,width:70,align:'center'}">漫画ID</th>
                                ...
                                <th lay-data="{field:'author',width:130,align:'center'}">漫画作者</th>
